...
const DataSidebar = () => {
  ...
  return (
    <div className="flex flex-wrap m-3 items-center w-5/6 ">
      ...
      <div className="w-24 h-16 p-2 text-center text-xs bg-white bg-gray-300 rounded m-2">
        <h1>Saved Frames</h1>
        <h1>
          {dashboard.frames.savedFrames}/{dashboard.frames.totalFrames}
        </h1>
      </div>
      <div className="w-24 h-16 p-2 text-center text-xs bg-white rounded m-2 bg-gray-200">
        <h1>Temperature</h1>
