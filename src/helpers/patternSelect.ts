...
export const MakePattern = (pattern: string) => {
  ...
  let { spins, set, currentUrl } = Store.getState().simulation;
  ...
  function MakeSquare() {
    for (var i = 0; i < latticeSize; i++) {
      for (var j = 0; j < latticeSize; j++) {
        if (
          Math.abs(latticeSize / 2 - i) < latticeSize * 0.1 &&
          Math.abs(latticeSize / 2 - j) < latticeSize * 0.1
        ) {
          spins[i][j] = 1;
        } else {
          spins[i][j] = -1;
  ...
  function MakeBeads() {
    for (var i = 0; i < latticeSize; i++) {
      for (var j = 0; j < latticeSize; j++) {
        if (
          Math.sqrt(
            (latticeSize / 2 - (j * 3 - latticeSize * 0.15)) ** 2 +
              (latticeSize / 2 - (i * 3 - latticeSize * 0.15)) ** 2
          ) <
            latticeSize / 2 ||
          Math.sqrt(
            (latticeSize / 2 - (j * 3 - latticeSize * 1.9)) ** 2 +
              (latticeSize / 2 - (i * 3 - latticeSize * 1.9)) ** 2
          ) <
            latticeSize / 2 ||
          Math.sqrt(
            (latticeSize / 2 - (j * 3 - latticeSize * 1.02)) ** 2 +
              (latticeSize / 2 - (i * 3 - latticeSize * 1.02)) ** 2
          ) <
            latticeSize / 2 ||
          i == j ||
          i == j - 1 ||
      ...
      for (var j = 0; j < latticeSize; j++) {
        if (
          ...
          Math.sqrt(
            ...
            latticeSize / 2 ||
          Math.sqrt(
            (latticeSize / 2 - (i * 3 - latticeSize * 0.1)) ** 2 +
              (latticeSize * 2.5 - j * 3 - 5) ** 2
          ) <
            latticeSize / 2 ||
          i == latticeSize - j - 1 ||
          i == j - 1 ||
  ...
  function MakeCircle() {
    for (var i = 0; i < latticeSize; i++) {
      for (var j = 0; j < latticeSize; j++) {
        if (
          Math.sqrt(
            (latticeSize / 2 - (j * 3 - latticeSize)) ** 2 +
              (latticeSize / 2 - (i * 3 - latticeSize)) ** 2
          ) <
          latticeSize / 2
        ) {
          spins[i][j] = 1;
      ...
      for (var j = 0; j < latticeSize; j++) {
        if (
          Math.sqrt(
            ...
            latticeSize / 2 &&
          Math.sqrt(
            (latticeSize / 2 - (j * 6 - latticeSize * 2.5)) ** 2 +
              (latticeSize / 2 - (i * 6 - latticeSize * 2.5)) ** 2
          ) >
            latticeSize / 2
        ) {
          spins[i][j] = 1;
